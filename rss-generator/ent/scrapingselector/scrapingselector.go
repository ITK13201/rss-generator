...
const (
	// Label holds the string label denoting the scrapingselector type in the database.
	Label = "scraping_selector"
	...
	EdgeSite = "site"
	// Table holds the table name of the scrapingselector in the database.
	...
	SiteColumn = "scraping_selector_id"
)
...
// OrderOption defines the ordering options for the ScrapingSelector queries.
